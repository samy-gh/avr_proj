...
extern volatile UCHAR gTimer1_ClockSelectBits;
extern volatile UINT gTimer1_PwmPeriod;
extern volatile UCHAR gTimer1_PwmPinAEnable;
extern volatile UCHAR gTimer1_PwmPinBEnable;
